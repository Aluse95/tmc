...
<script src="{{ asset('themes/frontend/xkld/js/jquery-3.2.1.min.js') }}"></script>
<script src="{{ asset('themes/frontend/xkld/js/popper.min.js') }}"></script>
<script src="{{ asset('themes/frontend/xkld/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('themes/frontend/xkld/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('themes/frontend/xkld/js/wow.min.js') }}"></script>
<script src="{{ asset('themes/frontend/xkld/js/custom.js') }}"></script>
<script src="{{ asset('themes/frontend/xkld/js/tobii.min.js') }}"></script>

<!-- swiper -->
<script src="{{ asset('../cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js') }}"></script>
