    ...
    <div class="row">
      <div class="col-lg-2 col-12 text-md-center">
        ...
        <a href="{{ route('frontend.home') }}" data-dark-logo="{{ $web_information->image->logo_header ?? '' }}"
          class="my-logo pt-1"><img class="logo-img" src="{{ $web_information->image->logo_header ?? '' }}" alt="Logo"  style="max-height: 75px;"/>
        </a>
        <!-- Button Menu -->
      ...
      <div class="col-lg-10 col-12">
        <div class="main-menu">
          ...
          <form class="search-form" action="{{ route('frontend.search.index') }}" method="get">
            <input type="search" name="keyword" placeholder="@lang('Nhập và tìm kiếm...')" value="{{ $params['keyword'] ?? '' }}" class="form-control" />
