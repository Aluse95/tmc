                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input name="json_params[shop_online]" class="form-control"
                        value="{{ $detail->json_params->shop_online ?? old('json_params[shop_online]') }}" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
