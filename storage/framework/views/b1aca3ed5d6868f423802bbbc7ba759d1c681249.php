            ...
            <ul class="nav nav-tabs">
              ...
              <li>
                <a href="#tab_3" data-toggle="tab">
                  <h5><?php echo app('translator')->get('Related Resource'); ?></h5>
                </a>
              </li>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Place'); ?></label>
                      <input name="json_params[place]" class="form-control"
                        value="<?php echo e($detail->json_params->place ?? old('json_params[place]')); ?>" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Total area'); ?></label>
                      <input name="json_params[area]" class="form-control"
                        value="<?php echo e($detail->json_params->area ?? old('json_params[area]')); ?>" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label><?php echo app('translator')->get('Project scale'); ?></label>
                      <input name="json_params[scale]" class="form-control"
                        value="<?php echo e($detail->json_params->scale ?? old('json_params[scale]')); ?>" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
      ...
      $(document).on('click', '.btn_search', function() {
        ...
        $.ajax({
          ...
          data: {
            ...
            is_type: "<?php echo e(App\Consts::POST_TYPE['resource']); ?>"
          },
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xkld\resources\views/admin/pages/cms_resources/create.blade.php ENDPATH**/ ?>