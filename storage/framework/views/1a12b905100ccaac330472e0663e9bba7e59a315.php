      ...
      <form action="<?php echo e(route(Request::segment(2) . '.index')); ?>" method="GET">
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label><?php echo app('translator')->get('Resource category'); ?></label>
                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <?php
                        $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['resource'], $row->alias ?? $row->title, $row->id, 'detail', $row->taxonomy_title);
                      ?>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\xkld\resources\views/admin/pages/cms_resources/index.blade.php ENDPATH**/ ?>