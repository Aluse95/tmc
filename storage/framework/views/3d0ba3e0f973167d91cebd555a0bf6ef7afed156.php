    ...
    <div class="owl-carousel owl-theme">
      ...
      <?php if($block_childs): ?>
        <?php $__currentLoopData = $block_childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="swiper-slide-bg owl-item bg-cover" style="background-image: url('<?php echo e($image); ?>')">
            <div class="overlay">
              <div class="container">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\xkld\resources\views/frontend/blocks/banner/styles/slide.blade.php ENDPATH**/ ?>